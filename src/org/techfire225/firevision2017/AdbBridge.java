 ...
 * AdbBridge provided by Team 254 https://github.com/Team254/FRC-2016-Public/blob/master/src/com/team254/frc2016/vision/AdbBridge.java
 */
public class AdbBridge {
    Path bin_location_;
    public final static Path DEFAULT_LOCATION = Paths.get("/usr/bin/adb");

    static final AdbBridge instance = new AdbBridge();
    ...
    private boolean runCommand(String args) {
        ...
        try {
            Process p = r.exec(cmd, new String[] { "HOME=/home/lvuser"});
            p.waitFor();
        } catch (IOException e) {
    ...
    public void restartApp() {
        ...
        runCommand("shell am force-stop org.techfire225.firevision2017");
        runCommand("shell am start org.techfire225.firevision2017/org.techfire225.firevision2017.MainActivity");
    }
