...
public class KPAOnly extends Autonomous {
	boolean leftSideBoiler;
	public KPAOnly(boolean leftSideBoiler) {
		...
		{  /* Go to hopper */
			...
			addSequential(new DriveDistance(2.73, 7, 5, 0, 7));
	...
	public String getAutonomousName() {
		return "KPA only with boiler on "+(leftSideBoiler?"left":"right");
	}
