...
public class KPAOnlyFast extends Autonomous {
	...
	public KPAOnlyFast(boolean leftSideBoiler) {
		...
		{  /* Go to hopper */
			...
			// Smash the wall
			addParallel(new DriveForTime(1.0, 0.5)); // (0.5, 0.7)
		}
		{   // collect from hopper
	...
	public String getAutonomousName() {
		return "Fast KPA only with boiler on "+(leftSideBoiler?"left":"right");
	}
